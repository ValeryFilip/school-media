...
function buildRedirectBlock(articleRedirects) {
  const lines = [
    ...
    'RewriteRule ^ https://egehim.ru%{REQUEST_URI}/ [R=301,L,QSA]',
    '',
    'RewriteCond %{REQUEST_FILENAME} !-f',
    'RewriteCond %{REQUEST_URI} !\\.[A-Za-z0-9]{1,8}$',
    'RewriteCond %{REQUEST_URI} !/$',
    ...
    'RewriteRule ^ https://egehim.ru%{REQUEST_URI} [R=301,L,QSA]',
    '',
    '# Legal docs redirects: old public URLs -> /docs/',
    'RewriteRule ^privacy/?$ /docs/privacy/ [R=301,L]',
    'RewriteRule ^agreement/?$ /docs/agreement/ [R=301,L]',
    'RewriteRule ^payment/?$ /docs/payment/ [R=301,L]',
    'RewriteRule ^marketing-consent/?$ /docs/marketing-consent/ [R=301,L]',
    'RewriteRule ^cookies/?$ /docs/cookies/ [R=301,L]',
    '',
